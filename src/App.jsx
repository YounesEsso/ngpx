  ...
  return(
    <div className="min-h-screen bg-black text-zinc-100" style={{backgroundImage:"radial-gradient(circle at 20% 30%, rgba(132,204,22,0.04), transparent 50%), radial-gradient(circle at 80% 70%, rgba(245,158,11,0.04), transparent 50%)"}}>
      ...
      <main className="py-4">
        ...
        {view==="placement"&&<Placement onComplete={handlePlacementComplete} resumeIdx={progress.placementIdx} resumePicks={progress.placementPicks} onSavePlacement={handleSavePlacement} user={user} onExit={onGoHome}/>}
        ...
        {view==="module"&&activeModuleId&&<ModuleView moduleId={activeModuleId} state={{...progress,userId:user.id}} onComplete={handleModuleComplete} onBack={handleModuleBack} onSaveQuizState={handleSaveQuizState} user={user} onContinue={(nextId)=>{setActiveModuleId(nextId);setView("module");}}/>}
