...
function LandingPage({onLogin,onSignUp}){
  ...
  return(
    <div className="min-h-screen bg-black text-zinc-100" style={{backgroundImage:"radial-gradient(circle at 20% 30%, rgba(132,204,22,0.04), transparent 50%)"}}>
      ...
      <footer className="border-t border-zinc-900 px-6 py-4 font-mono text-xs text-zinc-600 text-center">NGPX//ACADEMY · ENGIE EEMNA · Not financial advice</footer>
    </div>
  );
}
  ...
  if(phase==="lesson"){
    ...
    return(
      <div className="max-w-2xl mx-auto p-4 space-y-3">
        ...
        <Btn onClick={()=>setPhase("quiz")}>BEGIN QUIZ ({shuffledQuestions.length} QUESTIONS) <ChevronRight size={12} className="inline"/></Btn>
      </div>
    );
  }
