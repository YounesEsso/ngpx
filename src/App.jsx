          ...
          {done?(
            ...
            <div className="space-y-3 font-mono">
              <div>
                ...
                <input autoFocus type="email" autoComplete="email" value={email} onChange={e=>setEmail(e.target.value)} className={`w-full bg-zinc-900 border text-zinc-100 px-3 py-2 text-xs font-mono focus:outline-none ${email&&!emailLooksValid?"border-rose-700 focus:border-rose-500":"border-zinc-700 focus:border-lime-500"}`} placeholder="firstname.lastname@engie.com"/>
    ...
    <div className="min-h-screen bg-black text-zinc-100" style={{backgroundImage:"radial-gradient(circle at 20% 30%, rgba(132,204,22,0.04), transparent 50%)"}}>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="border border-zinc-800 bg-zinc-950/60 p-8 text-center font-mono">
          <div className="text-zinc-400 text-sm mb-2">Open to @engie.com employees.</div>
  ...
  if(phase==="lesson"){
    ...
    return(
      <div className="max-w-2xl mx-auto p-4 space-y-3">
        ...
        {/* "Ready?" callout — visually impossible to miss when user scrolls to the bottom */}
        <div className="border border-lime-600 bg-lime-950/20 px-4 py-4 text-center mt-2">
          <div className="font-mono text-lime-400 text-sm font-bold uppercase tracking-wider mb-1.5">▸ READY TO TEST WHAT YOU LEARNED?</div>
          <div className="font-mono text-lime-300/70 text-[11px] uppercase tracking-wider mb-3">{shuffledQuestions.length} QUESTIONS · ~3 MIN · 70% TO PASS</div>
          <button
